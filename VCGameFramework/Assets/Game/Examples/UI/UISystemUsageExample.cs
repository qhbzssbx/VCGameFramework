...
//            {
//                // 基本用法：显示UI并传递参数
//                var demoUI = await UIManagerService.Instance.ShowAsync<DemoUI>("Assets/AssetRaw/UI/DemoUI", "Hello from UI System!");
...
//            {
//                // 检查UI是否正在显示
//                if (UIManagerService.Instance.IsShowing<DemoUI>())
//                {
//                    await UIManagerService.Instance.HideAsync<DemoUI>();
...
//            try
//            {
//                await UIManagerService.Instance.ToggleAsync<DemoUI>("DemoUI", "切换显示的消息");
                
//                bool isShowing = UIManagerService.Instance.IsShowing<DemoUI>();
...
//            var demoUI = UIManagerService.Instance.GetPanel<DemoUI>();
...
//            {
//                // 显示主UI
//                await UIManagerService.Instance.ShowAsync<DemoUI>("DemoUI", "主UI面板");
                
//                // 延迟一下，然后显示弹窗
//                await UniTask.Delay(1000);
//                await UIManagerService.Instance.ShowAsync<DemoPopupUI>("DemoPopup", "这是一个弹窗");
...
//            try
//            {
//                await UIManagerService.Instance.HideAllAsync();
//                Debug.Log("✅ 所有UI已关闭");
//            }
//            catch (System.Exception ex)
//            {
...
//            Debug.Log($"DemoUI 是否显示: {UIManagerService.Instance.IsShowing<DemoUI>()}");
//            Debug.Log($"DemoPopupUI 是否显示: {UIManagerService.Instance.IsShowing<DemoPopupUI>()}");
            
//            var demoUI = UIManagerService.Instance.GetPanel<DemoUI>();
//            var popupUI = UIManagerService.Instance.GetPanel<DemoPopupUI>();
